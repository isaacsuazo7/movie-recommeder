...
class MoviesFantasy extends StatefulWidget {
  @override
  _MoviesFantasyState createState() => _MoviesFantasyState();
}

class _MoviesFantasyState extends State<MoviesFantasy> {
...
// and use it to retrieve the element
    String movie = fantasy[_random.nextInt(fantasy.length)];
    print(movie);
    return movie;
  }
}
