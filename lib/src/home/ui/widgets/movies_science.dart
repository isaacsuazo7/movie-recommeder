...
class MoviesScience extends StatefulWidget {
  @override
  _MoviesScienceState createState() => _MoviesScienceState();
}

class _MoviesScienceState extends State<MoviesScience> {
...
// and use it to retrieve the element
    String movie = scienceFiction[_random.nextInt(scienceFiction.length)];
    print(movie);
    return movie;
  }
}
