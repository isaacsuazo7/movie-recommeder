...
class MoviesComedy extends StatefulWidget {
  @override
  _MoviesComedyState createState() => _MoviesComedyState();
}

class _MoviesComedyState extends State<MoviesComedy> {
  ...
  String _movieRandom() {
    ...
    String movie = comedy[_random.nextInt(comedy.length)];
    print(movie);
    return movie;
  }
}
